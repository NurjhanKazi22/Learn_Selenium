package com.testwithnoor.ex11_File_Upload;

import com.testwithnoor.ex07_WaitHelper.WaitHelpers;
...
public class Lab38_FileUpload_BS {
    public static void main(String[] args) {
        ...
        String path = user_dir + "/src/main/java/com/testwithnoor/ex11_File_Upload/testdroid-sample-app.apk";
